...
This is the positive control for the diagnostics: the Duo, M4 and transportation vignettes show the small-sample case where no split is found, and the OpenProblems spatial vignette shows a split on real data. Here the split is recovered from a known construction.
