...
[ADR 0011](../adr/0011-glmmtmb-and-plackett-luce.md) records the design choices behind both additions. With them, the Phase 4 model set is complete: the mixed-effects variance decomposition, the Bradley-Terry trees, the glmmTMB beta engine, and Plackett-Luce.
