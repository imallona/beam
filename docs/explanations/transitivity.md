# Transitivity or whether one ranking is consistent with the pairwise evidence
...
[`beam.mcda.pairwise_transitivity`](../reference/pairwise_transitivity.qmd) checks for this. It reads the pairwise superiority report and asks whether the pairwise majority relation admits one consistent order.
