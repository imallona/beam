...
The Duo 2018 vignette works this through on the ARI scores, and [ADR 0009](../adr/0009-heterogeneity-mixed-effects-via-r.md) records why the fit runs in R through a subprocess.
