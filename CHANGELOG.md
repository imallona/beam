...
- Documentation: ADRs 0008 to 0014, findings 0001 to 0006, and explanation essays on MCDA, normalization, the heterogeneity diagnostics, the funky-heatmap robustness plot, missing data, and the Skillings-Mack coverage-aware Friedman test.
